    ...
    return /*html*/ `
        <div class="item_card">
            <div class="menu_title">
                ...
                <button id="quantity_up${j}" class="trash_btn" onclick="removeItem(${j})">
                    <svg
                        width="16"
                        height="18"
                        viewBox="0 0 16 18"
            ...
            <div class="menu_info">
                <div class="menu_amount">
                    <button id="quantity_down${j}" class="trash_btn d_none" onclick="removeItem(${j})">
                        <svg
                            width="16"
                            height="18"
                            viewBox="0 0 16 18"
                    ...
                    <button id="btn_minus${j}" class="amount_btn" onclick="decreaseAmount(${j})">-</button>
